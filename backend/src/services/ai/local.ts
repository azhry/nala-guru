...
const L1Templates: Array<() => ProblemData> = [
  () => ({
...
const L2Templates: Array<() => ProblemData> = [
  () => ({
    problemId: crypto.randomUUID(),
    prompt: 'What is 1 + 1?',
    choices: ['1', '3', '2', '4'],
...
const L3Templates: Array<() => ProblemData> = [
  () => ({
    problemId: crypto.randomUUID(),
    prompt: 'What is 10 + 5?',
    choices: ['12', '15', '14', '16'],
...
const L4Templates: Array<() => ProblemData> = [
  () => ({
    problemId: crypto.randomUUID(),
    prompt: 'What is 5 - 2?',
    choices: ['2', '4', '1', '3'],
...
const L5Templates: Array<() => ProblemData> = [
  () => ({
    problemId: crypto.randomUUID(),
